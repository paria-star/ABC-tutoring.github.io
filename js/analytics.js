...
// TODO: Replace YOUR_PROJECT_API_KEY below with your real PostHog project API key
// (from the assessment setup step). Update api_host if your project isn't on US cloud.
...
posthog.init('phc_pvcJsKVgqMKMWH2f8g2MSaSWCGLbGLXiwJExAyKTEr2B', {
  api_host: 'https://us.i.posthog.com',
  person_profiles: 'always'
});

// Helper so app.js can fire events without repeating posthog calls everywhere.
